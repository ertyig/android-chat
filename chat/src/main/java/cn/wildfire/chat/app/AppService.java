...
public class AppService implements AppServiceProvider {
    ...
    // ipv4
    // public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释，http 前缀不能省略*/ = "http://192.168.157.145:8888";
    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://10.1.114.152:90/prod-api/app";
